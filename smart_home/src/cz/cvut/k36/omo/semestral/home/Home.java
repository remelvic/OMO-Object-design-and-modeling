...
public class Home {
    ...
    private Home(int config) {
        if (config == 1) {
            stuffList = new ArrayList<>();
            inhabitantList = new ArrayList<>();
            inhabitantList.add(new Mom("Olivia", 31));
            inhabitantList.add(new Dad("Stan", 39));
            inhabitantList.add(new Child("Michal", 14));
            inhabitantList.add(new Grandpa("John", 67));
            inhabitantList.add(new Grandma("Bella", 73));
            inhabitantList.add(new Baby("Ben", 2));
            inhabitantList.add(new Cat("Snow", 5));
            inhabitantList.add(new Dog("Jack", 6));
            inhabitantList.add(new Parrot("Nick", 4));
            ...
            inhabitantList.add(new Dad("Stan", 39));
            inhabitantList.add(new Child("Michal", 14));
            inhabitantList.add(new Child("Maria",15));
            inhabitantList.add(new Grandpa("John", 67));
            inhabitantList.add(new Grandma("Bella", 73));
            inhabitantList.add(new Baby("Ben", 2));
            inhabitantList.add(new Baby("Mark",3));
            inhabitantList.add(new Cat("Snow", 5));
            inhabitantList.add(new Cat("Kitty",7));
            inhabitantList.add(new Dog("Jack", 6));
            inhabitantList.add(new Dog("Barak",4));
            inhabitantList.add(new Parrot("Nick", 4));
     ...
     */
    public synchronized static Home getInstance(int config) {
        if (INSTANCE == null){
